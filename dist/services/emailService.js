...
const sendCollaboratorWelcomeEmail = async (collaboratorEmail, collaboratorName, password) => {
    const transporter = createTransporter();
...
exports.sendCollaboratorWelcomeEmail = sendCollaboratorWelcomeEmail;
/** Notify a collaborator that a new project has been assigned to them. */
const sendCollaboratorProjectAssignedEmail = async (collaboratorEmail, collaboratorName, projectId, projectName) => {
    const transporter = createTransporter();
...
exports.sendCollaboratorProjectAssignedEmail = sendCollaboratorProjectAssignedEmail;
